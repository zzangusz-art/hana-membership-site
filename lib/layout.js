...
function page({ title, description, path, jsonld = [], body, breadcrumbs = [], ogImage, noindex = false, bodyClass = '', extraHead = '', dateModified }) {
  ...
  const og = ogImage ? (ogImage.startsWith('http') ? ogImage : shareOrigin() + ogImage) : shareOrigin() + '/img/og.png';
...
<meta property="og:title" content="${attr(ogTitle)}"><meta property="og:description" content="${attr(description)}"><meta property="og:url" content="${attr(url)}"><meta property="og:image" content="${attr(og)}"><meta property="og:image:secure_url" content="${attr(og)}"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta property="og:image:alt" content="${attr(ogTitle)}">
<meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="${attr(ogTitle)}"><meta name="twitter:description" content="${attr(description)}"><meta name="twitter:image" content="${attr(og)}">
